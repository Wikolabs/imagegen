...
export const metadata: Metadata = { title:"ImageGen — Agent IA de generation d'images enterprise", description:"Generez des visuels professionnels en quelques secondes. ImageGen cree des images sur-mesure pour vos campagnes marketing, produits e-commerce et communications d'entreprise." };
