...
const P = {
  name: "ImageGen",
  tagLabel: "Generation d'images IA · Enterprise · Sur-mesure",
  taglines: ["Un brief en quelques mots.", "Un visuel en quelques secondes.", "Votre creativite demultipliee."],
  taglineAccentIdx: 1,
  desc: "ImageGen genere des images professionnelles sur-mesure pour vos campagnes marketing, fiches produits e-commerce et communications internes — a partir d'une simple description en francais.",
  accent: "#FB923C",
  ...
  metrics: [{ value: "<10s", label: "generation par image" }, { value: "4K", label: "resolution maximale" }, { value: "∞", label: "styles disponibles" }, { value: "100%", label: "droits commerciaux" }],
  features: [
    { icon: "🎨", title: "Generation par description", desc: "Decrivez l'image souhaitee en francais. Produit sur fond blanc, personne en situation, paysage urbain — ImageGen comprend et genere." },
    { icon: "🏢", title: "Charte graphique integree", desc: "Uploadez votre charte : couleurs, polices, style visuel. ImageGen applique votre identite graphique a chaque generation automatiquement." },
    { icon: "⚡", title: "Generations en lot", desc: "Des dizaines de variantes en quelques minutes. Parfait pour les catalogues produits, les tests A/B visuels et les campagnes multicanal." },
  ],
  steps: [
    { num: "01", title: "Decrivez votre besoin", desc: "Interface simple : decrivez l'image en langage naturel, choisissez le style et les dimensions. Aucune competence en design requise." },
    { num: "02", title: "L'IA genere vos visuels", desc: "En moins de 10 secondes, plusieurs variantes sont proposees. Affinez avec des corrections en langage naturel jusqu'au resultat parfait." },
    { num: "03", title: "Exportez et publiez", desc: "Telechargez en haute resolution, PNG, JPEG ou SVG. Integrez directement a votre CMS, Shopify ou outils marketing via API." },
  ],
  testimonials: [
    { quote: "Notre equipe marketing genere maintenant 50 visuels par jour sans designer. ImageGen a divise notre budget creation par 5.", author: "Camille D.", role: "Directrice Marketing, E-commerce" },
    { quote: "Les fiches produits de notre catalogue sont passees de 2 semaines a 2 jours de production. La qualite est au rendez-vous.", author: "Hery R.", role: "Responsable E-commerce, Retailer Madagascar" },
  ],
  ctaTitle: "Generez des visuels a la vitesse de vos idees",
  ctaDesc: "Demo en 20 minutes. Premiers visuels generes en direct. Droits commerciaux inclus.",
  ctaPrimary: "Reserver une demo",
  footerTagline: "Agent IA de generation d'images enterprise",
};
